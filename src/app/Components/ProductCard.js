...
function ProductCard({ value , bgColor , borderRadius ,  cardHeight , innerHeight}) {
...
style={{
  ...
  ...(cardHeight && { minHeight: cardHeight }),
    ...
    >
      ...
      <div className="p-2 productInner d-flex flex-column justify-content-between"
      style={{
  ...(innerHeight && { minHeight: innerHeight})
}}>
        {/* <h4>{value?.name}</h4> */}
       <div>
        ...
        <p>
          ...
          {/* <span className="text-success text-bold"> {value?.discountedPrice} &#8377; </span> */}
               <span className="fw-bold"> {value?.price2} &#8377; </span>
        </p>
       </div>
