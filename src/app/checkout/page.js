            ...
            <div className="d-flex justify-content-center align-items-center ">
              ...
              <div className="d-flex justify-content-sm-around justify-content-center pb-sm-3 mb-1 flex-sm-row  flex-column">
                ...
                <div className="d-flex flex-column align-items-center">
                 ...
                 >
                     <p className="mb-sm-2 mb-1"><strong>UPI ID:</strong> myupi@bank</p>
          <p className="mb-sm-2 mb-1"><strong>Bank:</strong> HDFC Bank</p>
          <p className="mb-sm-2 mb-1"><strong>Account Number:</strong> 1234567890</p>
          <p className="mb-sm-2 mb-1"><strong>IFSC:</strong> HDFC0001234</p>
                  </div>
