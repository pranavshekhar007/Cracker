      ...
      <div className='policy-page d-flex flex-column align-items-center'>
         ...
         <div className='all-policies'>
            <div className='policy'>
                <h3>Introduction</h3>
                <p> Welcome to Gustosa Foods! These Terms of Use (“Terms”) govern your access to and use of our website,
                     products, and services. By accessing or using our platform, you agree to be bound by these Terms. 
                     If you disagree with any part of these Terms, you may not access the platform.</p>
            </div>
            <div className='policy'>
